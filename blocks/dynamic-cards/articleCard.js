...
function createCard(article, firstCard = false) {
  ...
  return li(
    {
      class:
        'w-full h-full article flex flex-col col-span-1 relative mx-auto justify-center overflow-hidden bg-transparent transform transition duration-500 hover:scale-105',
    },
    cardWrapper,
  );
}
