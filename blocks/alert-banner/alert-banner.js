...
export default function decorate(block) {
  ...
  const alertAnchor = a({ class: 'button bg-black hover:bg-[#3B3B3B] h-8 whitespace-nowrap rounded-2xl flex items-center py-2 px-3 text-white text-xs capitalize justify-self-end w-fit', href }, title);
