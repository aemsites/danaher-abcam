...
//   topImage.querySelector('img')?.classList.add(...'w-[500px]
// h-[220px] object-contain max-[767px]:w-[8.438rem] max-[767px]:h-[4.375rem]
// max-[1199px]:w-[300px] max-[767px]:h-[200px]'.split(' '));
//   bottomImage.querySelector('img')?.classList.add(...'w-[500px]
// h-[220px] object-contain max-[767px]:w-[8.438rem] max-[767px]:h-[4.375rem]
// max-[1199px]:w-[300px] max-[767px]:h-[200px]'.split(' '));
...
//   mainContainer.querySelector('.video-img').querySelector('img').classList.add
// (...'max-[767px]:h-[457px] max-[767px]:w-auto object-cover h-full'.split(' '));
...
//       div({ class: 'left-top-container flex flex-row
// justify-start max-[767px]:justify-center' }),
//       div(
//         { class: 'left-middle-container py-6 px-24 max-[1024px]:px-0 text-center' },
//         div({ class: 'heading-container pb-6 text-[83px] leading-[70px]
// max-[480px]:text-[24px] max-[480px]:leading-[24px] max-[640px]:text-[35px]
// max-[767px]:text-[45px] max-[767px]:leading-[45px] max-[992px]:text-[55px]
// max-[992px]:leading-[45px] max-[1199px]:text-[69px] max-[1199px]:leading-[50px]' }),
//         div({ class: 'text-container font-light text-[24px]
// leading-[1.9rem] max-[480px]:text-[20px] max-[480px]:leading-[27px]
// max-[767px]:text-[24px] max-[767px]:leading-[31px] max-[991px]:text-3xl
// max-[1200px]:text-[30px] max-[1200px]:leading-[1.9rem]' }),
//       ),
//       div({ class: 'left-bottom-container flex flex-row
// justify-end max-[767px]:justify-center' }),
//     ),
//     div(
...
//         div(
//           { class: 'video-play flex flex-col items-center justify-center
// max-[767px]:h-[28.563rem] max-[767px]:w-full h-full' },
...
//   }
//   const videoLink = block.firstElementChild.children[1]
// .firstElementChild.querySelector('a').href;
