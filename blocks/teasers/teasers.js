...
function createTeaserBlock(
  ...
  const openCloseIcon = openCloseIconClass ? span({ class: `icon ${openCloseIconClass} block -rotate-90 text-gray-400 fill-current size-5 group-hover:translate-x-0.5 invert transform transition-all` }) : '';
