...
export default function buildAutoBlocks(block) {
  ...
  const content = div({ class: 'main lg:px-16 sm:px-10 pb-10 px-5' });
  ...
  const headTitle = div(
    ...
    div(
      ...
      h1({ class: 'my-5 text-black-0 lg:text-7xl sm:text-[50px] mb-8 font-semibold tracking-normal text-3xl' }, title),
