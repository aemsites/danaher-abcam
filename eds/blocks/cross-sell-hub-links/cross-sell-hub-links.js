...
export default async function decorate(block) {
  ...
  let appGuides = await ffetch('/en-us/technical-resources/guides/query-index.json').all();
  ...
  //   raGuidesDiv.querySelector('ul')
  // .appendChild(li({ class: 'mb-4 font-semibold text-lg text-[#378189] hover:underline' }, a({ href: element.path }, element.title.replace(/\s*\|\s*abcam$/i, ''))));
  // });
  block.innerText = '';
