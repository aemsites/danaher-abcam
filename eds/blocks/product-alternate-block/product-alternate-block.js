...
export default function decorate(block) {
  ...
  // alternateBlock.parentElement.style.background = 'linear-gradient
  // (90.42deg, #4BA6B3 0.44%, #C9D3B7 35.08%, #FF8730 69.72%, #C54428 99.71%)';
  ...
  const staticBlock = div(
    { class: 'flex flex-col gap-1 font-sans text-base tracking-wide font-normal' },
    div(
  ...
  const expandedDiv = div(
    p({ class: 'pb-6' }, 'We’re constantly upgrading our range to offer the highest quality products when you need them. This product will be one of the following alternatives:'),
